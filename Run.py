...
def generate_response(categorized_emotions, tweet, emotions, persona_emotions, api_url):
...
def process_tweet(tweet, persona_emotions):
    ...
    response = generate_response(categorized_emotions, tweet, emotions, persona_emotions,api_link)
